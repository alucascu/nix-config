...
<svg xmlns="http://www.w3.org/2000/svg" width="704" height="634" viewBox="0 0 704 634" font-family="system-ui, -apple-system, 'Segoe UI', sans-serif">
<rect width="704" height="634" fill="#FFFFFF"/>
<rect x="32" y="32" width="640" height="546" rx="14" fill="#EEEDFE" stroke="#534AB7" stroke-width="1.0" />
<text x="52" y="63" text-anchor="start" font-size="15" font-weight="500" fill="#3C3489" dominant-baseline="central">greek  —  Physical</text>
<rect x="52" y="84" width="600" height="230" rx="10" fill="#E1F5EE" stroke="#0F6E56" stroke-width="0.8" />
...
<rect x="68" y="154" width="568" height="36" rx="6" fill="#F1EFE8" stroke="#5F5E5A" stroke-width="0.5" />
...
<rect x="68" y="200" width="279" height="44" rx="6" fill="#FAECE7" stroke="#993C1D" stroke-width="0.5" />
...
<rect x="357" y="200" width="279" height="44" rx="6" fill="#FAECE7" stroke="#993C1D" stroke-width="0.5" />
...
<rect x="68" y="254" width="279" height="44" rx="6" fill="#FAECE7" stroke="#993C1D" stroke-width="0.5" />
...
<rect x="52" y="328" width="600" height="130" rx="10" fill="#E1F5EE" stroke="#0F6E56" stroke-width="0.8" />
...
<rect x="68" y="398" width="279" height="44" rx="6" fill="#FAECE7" stroke="#993C1D" stroke-width="0.5" />
...
<rect x="357" y="398" width="279" height="44" rx="6" fill="#FAECE7" stroke="#993C1D" stroke-width="0.5" />
...
<rect x="52" y="472" width="600" height="86" rx="10" fill="#E1F5EE" stroke="#0F6E56" stroke-width="0.8" />
